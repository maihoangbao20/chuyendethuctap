...
@section('title', 'EStore - ' . $brand->name)
    ...
    <div class="breadcrumb-wrap">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('brand.products', ['id' => $brand->id]) }}">{{ $brand->name }}</a></li>
                <li class="breadcrumb-item">
                    <h1 class="breadcrumb-title">{{ $brand->name }}</i></h1>
                </li>
            </ul>
        </div>
    </div>
