...
@section('title','EStore - Sản phẩm mới nhất')
@section('content')
<body>
    ...
    <div class="breadcrumb-wrap">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Sản phẩm mới nhất</li>
                <li class="breadcrumb-item">
                    <h1 class="breadcrumb-title">Sản Phẩm Mới  <i class="fas fa-gift"></i></h1>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                                        ...
                                        <div class="product-categories">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a href="{{ route('category.products', ['id' => $category->id]) }}" class="dropdown-item">{{ $category->name }}</a>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-md-12 d-flex justify-content-center" style="margin-top: 0; margin-bottom: 10px;">
                    {{ $productnews->links('frontend.pagination') }}
                </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="product-item">
                                                ...
                                                <div class="product-price">
                                                    ...
                                                    @endif
                                                    <a class="btn" href=""><i class="fa fa-shopping-cart">Mua ngay</i></a>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 401 && xhr.responseJSON.login_required) {
                        $('#loginRequiredModalMessage').text(xhr.responseJSON.message);
                        $('#loginRequiredModalLink').attr('href', '{{ route('login') }}').text('Đăng nhập');
                        $('#loginRequiredModal').modal('show');
