...
@section('title', 'EStore - Tìm kiếm sản phẩm')
...
@section('content')
    ...
    <div class="product-view">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="breadcrumb-title">Kết quả tìm kiếm cho "<span>{{ request()->get('query') }}</span>"</h1>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        @if($products->isEmpty())
                                            <div class="col-md-12">
                                                <p>Không tìm thấy sản phẩm nào phù hợp với từ khóa "{{ request()->get('query') }}".</p>
                                            </div>
                                        @else
