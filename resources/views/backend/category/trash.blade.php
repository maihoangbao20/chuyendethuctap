          ...
          <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
              ...
              @endphp
                ...
                <td class="text-center" >
                  <a onclick="return confirm('Bạn chắc chắn muốn khôi mục?')" href="{{ route('admin.category.restore', ['id' => $row->id]) }}" class="btn btn-sm btn-success">
                      <i class="fas fa-undo"></i> Restore
                  </a>
                  <form action="{{ route('admin.category.destroy', ['id' => $row->id]) }}" method="POST" style="display: inline;">
                      @csrf
                      @method('DELETE')
