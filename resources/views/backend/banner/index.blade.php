                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.banner.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('name')}}" name="name" id="name" class="form-control" placeholder="Nhập tên banner..." required>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('description') }}" name="description" id="description" class="form-control small-placeholder" placeholder="Nhập mô tả..." required>
                                </div>
                                <div class="form-group">
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @else
                                    <a href="{{ route('admin.banner.status',['id'=>$row->id]) }}" class="btn btn-sm btn-danger">
