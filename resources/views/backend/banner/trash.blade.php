        ...
        @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>Thông tin:</p>
                    <ul>
                        <li>Tổng số banner đã xóa: {{ $deletedbannersCount }}</li>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->position}}</td>
                                <td class="text-center">
                                  <a href="{{ route('admin.banner.restore', ['id' => $row->id]) }}" class="btn btn-sm btn-success" 
                                  onclick="return confirm('Bạn chắc chắn muốn khôi phục banner này?')">
                                      <i class="fas fa-undo"></i> Restore
                                  </a>
                                  <form action="{{ route('admin.banner.destroy', ['id' => $row->id]) }}" method="POST" style="display: inline;">
                                      @csrf
                                      @method('DELETE')
                                      <button type="submit" class="btn btn-sm btn-danger" 
                                      onclick="return confirm('Bạn chắc chắn muốn xóa vĩnh viễn banner này?')">
